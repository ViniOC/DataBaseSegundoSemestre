...
CREATE SEQUENCE sq_rhstu_bairro START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_bairro BEFORE
    INSERT ON t_rhstu_bairro
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_cidade START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_cidade BEFORE
    INSERT ON t_rhstu_cidade
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_consulta_forma_pagto START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_consulta_forma_pagto BEFORE
    INSERT ON t_rhstu_consulta_forma_pagto
    FOR EACH ROW
    WHEN ( new.id_consulta_forma_pagto IS NULL )
BEGIN
    :new.id_consulta_forma_pagto := sq_rhstu_consulta_forma_pagto.nextval;
END;
/

CREATE SEQUENCE sq_rhstu_end_paciente START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_end_paciente BEFORE
    INSERT ON t_rhstu_endereco_paciente
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_estado START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_estado BEFORE
    INSERT ON t_rhstu_estado
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_logradouro START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_logradouro BEFORE
    INSERT ON t_rhstu_logradouro
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_medicamento START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_medicamento BEFORE
    INSERT ON t_rhstu_medicamento
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_medico START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_medico BEFORE
    INSERT ON t_rhstu_medico
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_paciente START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER th_rhstu_paciente BEFORE
    INSERT ON t_rhstu_paciente
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_paciente_plano_saude START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_paciente_plano_saude BEFORE
    INSERT ON t_rhstu_paciente_plano_saude
    FOR EACH ROW
    WHEN ( new.id_paciente_ps IS NULL )
BEGIN
    :new.id_paciente_ps := sq_rhstu_paciente_plano_saude.nextval;
END;
/

CREATE SEQUENCE sq_rhstu_precricap_medica START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_rhstu_precricap_medica BEFORE
    INSERT ON t_rhstu_prescicao_medica
    FOR EACH ROW
    WHEN ( new.id_prescricao_medica IS NULL )
BEGIN
    :new.id_prescricao_medica := sq_rhstu_precricap_medica.nextval;
END;
/

CREATE SEQUENCE sq_rhstu_tipo_contato START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER sq_rhstu_tipo_contato BEFORE
    INSERT ON t_rhstu_tipo_contato
    FOR EACH ROW
...
CREATE SEQUENCE sq_unid_hospital START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tg_unid_hospital BEFORE
    INSERT ON t_rhstu_unid_hospitalar
    FOR EACH ROW
    WHEN ( new.id_unid_hospital IS NULL )
BEGIN
    :new.id_unid_hospital := sq_unid_hospital.nextval;
END;
/
