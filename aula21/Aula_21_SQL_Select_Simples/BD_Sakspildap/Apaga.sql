...
drop sequence SQ_SAK_BAIRRO;
drop sequence SQ_SAK_CIDADE;
drop sequence SQ_SAK_DEPENDENTE;
drop sequence SQ_SAK_DEPTO;
drop sequence SQ_SAK_ENDERECO;
drop sequence SQ_SAK_ESTADO;
drop sequence SQ_SAK_EXECUCAO_PROJ;
drop sequence SQ_SAK_FUNCIONARIO;
drop sequence SQ_SAK_FUNCIONARIO_ENDERECO;
drop sequence SQ_SAK_PROJETO;
drop sequence SQ_SAK_TIPO_ENDERECO;
